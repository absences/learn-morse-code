...
import greate from '../data/greate.json'
...
function WordListPickerContextProvider(props) {
    ...
    switch (wordListCategory) {
        ...
        case "common100":
            ...
            break
        case "greate":
            wordList = greate.words
            break
        default:
            wordList = alphabet.words
    }

    const [wordListCount, setWordListCount] = useState(wordList.length)
    ...
    const metadata = {
        ...
        'greate': {name: '远大前程', description: '<远大前程>第一章'},
    }
